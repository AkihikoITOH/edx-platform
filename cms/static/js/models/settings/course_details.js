...
var CourseDetails = Backbone.Model.extend({
    ...
    validate: function(newattrs) {
        ...
        if(_.has(newattrs, 'entrance_exam_minimum_score_pct')){
            var intWeight = Math.round(newattrs.entrance_exam_minimum_score_pct); // see if this ensures value saved is int
            if (!isFinite(intWeight) || /\D+/.test(newattrs.entrance_exam_minimum_score_pct) || intWeight < 0 || intWeight > 100) {
